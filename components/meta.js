...
export default function Meta() {
  return (
    <Head>
      ...
      <meta name="apple-mobile-web-app-title" content="Devanshi Desai" />
      <meta name="description" content="Devanshi Desai Personal Portfolio" />
      ...
      <meta name="twitter:title" content="Devanshi Desai" />
      <meta name="twitter:description" content="Devanshi Desai personal portfolio" />
      <meta name="twitter:creator" content="@Devansh70765923" />
...
667px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
      />
      <link
        rel="apple-touch-startup-image"
        href="apple-splash-1334-750.jpg"
        media="(device-width: 375px) and (device-height:
667px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)"
      />
      <link
        rel="apple-touch-startup-image"
        href="apple-splash-640-1136.jpg"
        media="(device-width: 320px) and (device-height:
568px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)"
      />
      <link
        rel="apple-touch-startup-image"
